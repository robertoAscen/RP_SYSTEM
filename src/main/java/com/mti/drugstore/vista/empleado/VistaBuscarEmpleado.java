 ...
 */
package com.mti.drugstore.vista.empleado;
 ...
 * @author RAscencio
 */
public class VistaBuscarEmpleado extends JFrame
{    
    ...
    public void initComponents()
    {
        ...
        jb_1 = new JButton();
        jb_1.setText("Nuevo");
        jb_1.setIcon(new ImageIcon(pathImageIcons+"newCliente.png"));
        ...
        jlImageObj.setIcon(new ImageIcon(pathImageIcons+"employee128x128.png"));
        ...
        jlFindObj.setText("BUSCAR VENDEDOR");
        ...
        titleTableObj = new TitledBorder("Vendedores");
        ...
        new String []
        {
            "ID VENDEDOR", "NOMBRE", "DIRECCIÓN", "TELÉFONO"
        })
        {
