 ...
 */
package com.mti.drugstore.vista.cliente;
...
public class VistaBuscarCliente extends JFrame        
{
    ...
    public void initComponents()
    {
        ...
        jlImageObj.setIcon(new ImageIcon(pathImageIcons+"clienteSale.png"));
        ...
        jlFindObj.setText("BUSCAR CLIENTE");
        ...
        titleTableObj = new TitledBorder("Cliente");
