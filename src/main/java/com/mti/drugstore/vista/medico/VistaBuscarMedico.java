 ...
 */
package com.mti.drugstore.vista.medico;
 ...
 * @author RAscencio
 */
public class VistaBuscarMedico extends JFrame
{
    ...
    public void initComponents()
    {
        ...
        jb_1 = new JButton();
        jb_1.setText("Nuevo");
        jb_1.setIcon(new ImageIcon(pathImageIcons+"newDoctor.png"));
        ...
        jlImageObj.setIcon(new ImageIcon(pathImageIcons+"ambulance.png"));
        ...
        jlFindObj.setText("BUSCAR MÉDICO");
        ...
        titleTableObj = new TitledBorder("Médicos");
        ...
        new String []
        {
            "# CEDULA", "NOMBRE", "ESPECIALIDAD", "TELÉFONO"
        })
        {
