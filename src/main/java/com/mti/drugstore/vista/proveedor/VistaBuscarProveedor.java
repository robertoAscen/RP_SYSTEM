 ...
 */
package com.mti.drugstore.vista.proveedor;
...
public class VistaBuscarProveedor extends JFrame
{
    ...
    public void initComponents()
    {
        ...
        jb_1 = new JButton();
        jb_1.setText("Nuevo");
        jb_1.setIcon(new ImageIcon(pathImageIcons+"NuevoProveedor.png"));
        ...
        jlImageObj.setIcon(new ImageIcon(pathImageIcons+"supplier.png"));
        ...
        jlFindObj.setText("BUSCAR PROVEEDOR");
        ...
        titleTableObj = new TitledBorder("Proveedores");
        ...
        new String []
        {
            "RAZON SOCIAL", "DIRECCIÓN", "CONTACTO", "TELÉFONO"
        })
        {
